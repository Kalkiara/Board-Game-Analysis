...
```{r}
# path for cleaned data within working directory
...
# write dataframes to csv in the specified folder
write.csv(df_seed, file.path(folder_path, "output_file.csv"), row.names = FALSE)

```

Handle outliers and make data ready for modelling
